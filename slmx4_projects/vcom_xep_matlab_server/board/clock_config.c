...
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 144 MHz}
...
- {id: SEMC_CLK_ROOT.outFreq, value: 160 MHz}
...
- {id: CCM.FLEXSPI_PODF.scale, value: '5'}
- {id: CCM.FLEXSPI_SEL.sel, value: CCM_ANALOG.PLL3_PFD0_CLK}
- {id: CCM.LPSPI_PODF.scale, value: '5', locked: true}
- {id: CCM.PERCLK_PODF.scale, value: '2', locked: true}
- {id: CCM.PERIPH_CLK2_SEL.sel, value: XTALOSC24M.OSC_CLK}
- {id: CCM.SEMC_ALT_CLK_SEL.sel, value: CCM_ANALOG.PLL3_PFD1_CLK}
...
- {id: CCM_ANALOG.PLL2_PFD2_DIV.scale, value: '24', locked: true}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set FLEXSPI_PODF. */
    CLOCK_SetDiv(kCLOCK_FlexspiDiv, 4);
