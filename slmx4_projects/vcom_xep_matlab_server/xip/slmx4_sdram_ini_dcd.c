...
const uint8_t dcd_data[] = {
	...
	/* #1.98, command: write_value, address: SEMC_BR0, value: 0x80000017, size: 4 */
	0x40, 0x2F, 0x00, 0x10, 0x80, 0x00, 0x00, 0x17,
	/* #1.99, command: write_value, address: SEMC_BR1, value: 0x82000017, size: 4 */
	0x40, 0x2F, 0x00, 0x14, 0x82, 0x00, 0x00, 0x17,
	/* #1.100, command: write_value, address: SEMC_BR2, value: 0x84000017, size: 4 */
	0x40, 0x2F, 0x00, 0x18, 0x84, 0x00, 0x00, 0x17,
	/* #1.101, command: write_value, address: SEMC_BR3, value: 0x86000017, size: 4 */
	0x40, 0x2F, 0x00, 0x1C, 0x86, 0x00, 0x00, 0x17,
	/* #1.102, command: write_value, address: SEMC_BR4, value: 0x90000021, size: 4 */
	0x40, 0x2F, 0x00, 0x20, 0x90, 0x00, 0x00, 0x21,
	/* #1.103, command: write_value, address: SEMC_BR5, value: 0xA0000015, size: 4 */
	0x40, 0x2F, 0x00, 0x24, 0xA0, 0x00, 0x00, 0x15,
	...
	/* #1.107, command: write_value, address: SEMC_IOCR, value: 0x1007988, size: 4 */
	0x40, 0x2F, 0x00, 0x04, 0x01, 0x00, 0x79, 0x88,
	/* #1.108, command: write_value, address: SEMC_SDRAMCR0, value: 0xFF1, size: 4 */
	0x40, 0x2F, 0x00, 0x40, 0x00, 0x00, 0x0F, 0xF1,
	...
	/* #1.112, command: write_value, address: SEMC_DBICR0, value: 0x4031, size: 4 */
	0x40, 0x2F, 0x00, 0x80, 0x00, 0x00, 0x40, 0x31,
